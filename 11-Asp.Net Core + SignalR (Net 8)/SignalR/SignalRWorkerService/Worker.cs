...
namespace SignalRWorkerService
{
    public class Worker(ILogger<Worker> logger, IConfiguration configuration) : BackgroundService //primary const

    {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            connection!.On<Product>("ReceiveMessageForAllClient",
